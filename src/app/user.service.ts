...
export class UserService {
  private userInfo = {
    ...
    Bachelor's Degree in Information Systems. I love to develop and study software development. In my free time, I like to play with my puppy(Totti), watch series, read manga and play some games.In my free time I like to play with my puppy(Totti), watch series, read manga and play some games.
   `,
